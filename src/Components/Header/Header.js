  ...
  const content = [
    {
      ...
      description: 'Capaz de resolver cualquier consulta en casos de Responsabilidad Médica, Derecho Disciplinario para las Fuerzas Militares, Policía, Inpec y áreas afines',
